...
legend((adolc_taping, 
    adolc_function, 
    # function_lapack, 
    function_my_c_implementation, 
    # function_my_cpp_implementation
    ),
    ('ADOL-C (taping))', 
      'ADOL-C', 
      # 'LAPACK',
...
legend((gradient_utps_adolc,
    gradient_utps_tapenade,
    gradient_utpm_my_c_implementation,
    # gradient_utpm_lapack
    ),
    ('UTPS (ADOL-C)',
        'UTPS (Tapenade)',
        'UTPM (C)',
